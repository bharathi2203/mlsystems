...
def matrix_power_kernel(
    ...
    """
    TODO: Implement Triton matrix_power kernel
...
def matrix_power_triton(input_tensor: torch.Tensor, **kwargs) -> torch.Tensor:
    """
    Host function for Triton matrix_power
