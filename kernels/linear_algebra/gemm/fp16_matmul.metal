...
/**
 * Metal void solve(const half* A, const half* B, half* C, int M, int N, int K, float alpha, float beta) {
 * 
...
kernel void fp16_matmul_main(
    ...
    // TODO: Implement Metal fp16_matmul kernel
