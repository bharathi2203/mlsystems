...
"""
Triton Multihead Self Attention Kernel
...
@triton.jit
def multihead_self_attention_kernel(
    ...
    """
    TODO: Implement Triton multihead_self_attention kernel
...
def multihead_self_attention_triton(input_tensor: torch.Tensor, **kwargs) -> torch.Tensor:
    """
    Host function for Triton multihead_self_attention
