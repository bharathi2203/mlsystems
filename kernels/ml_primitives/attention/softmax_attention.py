...
"""
Triton Softmax Attention Kernel
...
def softmax_attention_kernel(
    ...
    """
    TODO: Implement Triton softmax_attention kernel
...
def softmax_attention_triton(input_tensor: torch.Tensor, **kwargs) -> torch.Tensor:
    """
    Host function for Triton softmax_attention
