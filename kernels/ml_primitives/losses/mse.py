...
"""
Triton void solve(const float* predictions, const float* targets, float* mse, int N) {
...
def mse_kernel(
    ...
    """
    TODO: Implement Triton mse kernel
...
def mse_triton(input_tensor: torch.Tensor, **kwargs) -> torch.Tensor:
    """
    Host function for Triton mse
