...
def cross_entropy_kernel(
    ...
    """
    TODO: Implement Triton cross_entropy kernel
...
def cross_entropy_triton(input_tensor: torch.Tensor, **kwargs) -> torch.Tensor:
    """
    Host function for Triton cross_entropy
