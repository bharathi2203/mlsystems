...
def rms_norm_kernel(
    ...
    """
    TODO: Implement Triton rms_norm kernel
...
def rms_norm_triton(input_tensor: torch.Tensor, **kwargs) -> torch.Tensor:
    """
    Host function for Triton rms_norm
