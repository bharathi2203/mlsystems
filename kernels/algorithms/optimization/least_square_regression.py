...
"""
Triton Least Square Regression Kernel
...
@triton.jit
def least_square_regression_kernel(
    ...
    """
    TODO: Implement Triton least_square_regression kernel
...
def least_square_regression_triton(input_tensor: torch.Tensor, **kwargs) -> torch.Tensor:
    """
    Host function for Triton least_square_regression
