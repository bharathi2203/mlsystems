...
"""
Triton void solve(const float* input, float* output, int N) {
...
def prefix_sum_kernel(
    ...
    """
    TODO: Implement Triton prefix_sum kernel
...
def prefix_sum_triton(input_tensor: torch.Tensor, **kwargs) -> torch.Tensor:
    """
    Host function for Triton prefix_sum
